...
<body style="background: #e2e3e5;">
	<nav class="navbar navbar-expand-lg" style="background: #385a64;">
		<div class="container-fluid ">
			<a class="navbar-brand" aria-current="page" href="index"> <img
				src="https://images-ext-2.discordapp.net/external/hVEzhQnNsZSIyyI_K5VXuRLDlr7hrZJQCr06zUXmBZw/https/i.pinimg.com/originals/d3/8d/09/d38d095f49c32da7b69171fc379cdacf.png?width=676&height=676"
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					<li class="nav-item">
						<form action="index" method="post">
							...
							<input type="hidden" name="pagAnt" value="index">
							<ul style="padding: 0">
				...
				<form action="index" method="post" role="search" style="width: 70%">
						<input type="hidden" name="login" value="<c:out value="${login}"></c:out>">
						<input type="hidden" name="qtdPedido" value="<c:out value="${qtdPedido}"></c:out>">
					<div class="input-group">
						...
						<label class="btn text-white" style="background: #fb735d; border-radius: 0px 5px 5px 0px">
							<i class="fas fa-search text-white"></i><input type="submit"
							name="botao" style="display: none;" value="Pesquisar">
						</label>
					</div>
				</form>
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item">
						<form action="index" method="post">
							...
							<input type="hidden" name="qtdPedido" value="<c:out value="${qtdPedido}"></c:out>">
							<ul style="padding: 0">
								<li class="list-group-item position-relative d-flex justify-content-between align-items-center">
	...
	<div class="container">
		<div class="row formPai">
			<c:forEach var="l" items="${maisVendidos}">
				<form action="index" method="post" class="cartao">
					<input type="hidden" name="login" value="<c:out value="${login}"></c:out>">
					<input type="hidden" name="qtdPedido" value="<c:out value="${qtdPedido}"></c:out>">
					<div class="card mb-3">
						...
						<ul class="list-group list-group-flush">
							<li class="list-group-item"><label class="btn btn-outline-success"> 
