						...
						<form action="index" method="post">
							...
							<ul style="padding: 0">
								<li class="list-group-item"><label
									class="btn btn-lg text-white" style="background: #385a64;">
										<i class="fas fa-home"></i> Home<input type="submit"
										name="botao" style="display: none;" value="Home">
								</label></li>
							</ul>
						</form>
					</li>
		...
		<div class="row formPai">
			<c:forEach var="l" items="${maisVendidos}">
				<form action="index" method="post" class="cartao">
					...
					<input type="hidden" name="qtdPedido" value="<c:out value="${qtdPedido}"></c:out>">
					<div class="card mb-3">
						<img src="${l.linkImagem}" style="height: 447px;"
						...
						<div class="card-body">
							<h6 class="card-title">
								...
								<input type="hidden" name="titulo"
									value="<c:out value="${l.titulo}"></c:out>">
							</h6>
							<p class="card-text sinopse" style="font-size: 13px;">
								<c:out value="${l.sinopse}"></c:out>
							</p>
